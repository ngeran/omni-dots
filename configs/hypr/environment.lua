-- =============================================================================
-- environment.lua — NixOS + OLED Longevity Environment Setup
-- =============================================================================
...
-- Forces Qt to use Wayland natively and maps styling to qt5ct/qt6ct.
...
hl.on("hyprland.start", function()
  ...
  -- This is critical for screen sharing (Portals) and apps like Thunar/Gwenview.
  hl.exec_cmd(
  ...
  -- 2. Set GTK color-scheme via gsettings (affects GTK3/4 apps)
  ...
  -- 8. Settings dashboard (Control module)
  hl.exec_cmd("quickshell -c ~/.config/quickshell/settings &")

  -- 9. Polkit Agent (Elevated permissions UI)
  hl.exec_cmd("/usr/lib/polkit-gnome/polkit-gnome-authentication-agent-1 &")

  -- 10. Start Hypridle LAST
  -- Seed a WRITABLE runtime config then launch.
