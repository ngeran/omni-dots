...
#
# Defines:
#   1. devShells.default — hugo + node (asset pipeline) + wrangler, direnv-loaded.
#   2. packages.image    — an OCI image: nginx serving the built static site.
#   3. packages.site     — the built static site itself (Cloudflare Pages upload).
#
    ...
    in {
      packages = forAllSystems (system:
        ...
        in {
          ...
          site  = staticAssets;          # built static site → `nix build .#site` (Cloudflare Pages upload)
